...
public class ReviewController {
    ...
    @PostMapping
    private ReviewResponseDto createReview(@RequestBody ReviewRequestDto reviewRequestDto) {

        if (Objects.isNull(reviewRequestDto.getReview_id()) ||
                Objects.isNull(reviewRequestDto.getHotel_id())) {
            // Bad Request
        }
